$(document).ready(function () {
    ...
    var c = $("#c");
    var w, h; var pi = Math.PI;
    var all_attribute = {
        num: 10, start_probability: 0.1,
        size_min: 1, size_max: 1.2, size_add_min: 0.3,
        size_add_max: 0.5, opacity_min: 0.3, opacity_max: 0.5,
        opacity_prev_min: .003, opacity_prev_max: .005, light_min: 0,
        light_max: 90,
    };
